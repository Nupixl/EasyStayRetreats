/**
 * EasyStay Search Properties - Webflow Cloud Hosted
 * Complete functionality for search properties page
 */

(function() {
  'use strict';
  
  if (window.EasyStaySearchLoaded) return;
  
  console.log('🏠 EasyStay Search Properties - Loading from Webflow Cloud...');
  ...
  window.EasyStaySearchLoaded = true;
  console.log('✅ EasyStay Search Properties loaded from Webflow Cloud!');
})();
