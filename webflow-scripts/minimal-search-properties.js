/**
 * EasyStay Minimal Search Properties
 * Essential functionality only - under 200 lines
 */

(function() {
  'use strict';
  
  if (window.EasyStayMinimalLoaded) return;
  
  console.log('🏠 EasyStay Minimal - Loading essential functionality...');
  ...
  window.EasyStayMinimalLoaded = true;
  console.log('✅ EasyStay Minimal loaded');
})();
