...
import _styles from "./StatContainer.module.css";
...
export function StatContainer({
  ...
  textStatTitle = "Stat Title",
  textStatChange = "+24.3% from last month",
  textStatFeature = "+$187K",
  visibilityStatCard = true,
  visibilityTopSection = true,
  visibilityBottomSection = true,
  visibilityMainStataIcon = true,
  iconStatTitleIcon = "",
  iconMainStatIcon = "",
  visibilityStatTitleIcon = true,
  variant = "Base",
}) {
  ...
  const _styleVariantMap = {
    Base: "",
    Hover: "w-variant-9a5d211e-a97a-db50-71b9-214036b7f29c",
  };

  const _activeStyleVariant = _styleVariantMap[variant];

  return visibilityStatCard ? (
    <_Component
      className={_utils.cx(_styles, "stat-card", _activeStyleVariant)}
      tag="div"
    >
      {visibilityTopSection ? (
        <_Builtin.Block
          className={_utils.cx(
            _styles,
        ...
        >
          ...
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "subtitle", _activeStyleVariant)}
              tag="div"
            >
              {textStatTitle}
            </_Builtin.Block>
            {visibilityStatTitleIcon ? (
              <_Builtin.Block
                className={_utils.cx(
                  _styles,
        ...
        >
          ...
          >
            <_Builtin.Block
              ...
              tag="div"
            >
              <_Builtin.Heading tag="h3">{textMainStat}</_Builtin.Heading>
            </_Builtin.Block>
            {visibilityMainStataIcon ? (
              <_Builtin.Block
                className={_utils.cx(
                  _styles,
                  "stat-card-indicator",
              ...
              >
                <_Builtin.Image
                  ...
                  height="auto"
                  alt=""
                  src={iconMainStatIcon}
                />
              </_Builtin.Block>
            ) : null}
          </_Builtin.Block>
          <_Builtin.Block
            className={_utils.cx(_styles, "stat-change", _activeStyleVariant)}
            tag="div"
          >
            <_Builtin.Block tag="div">{textStatChange}</_Builtin.Block>
          </_Builtin.Block>
          <_Builtin.Block
            className={_utils.cx(_styles, "stat-feature", _activeStyleVariant)}
            tag="div"
          >
            <_Builtin.Block tag="div">{textStatFeature}</_Builtin.Block>
          </_Builtin.Block>
        </_Builtin.Block>
      ) : null}
    </_Component>
