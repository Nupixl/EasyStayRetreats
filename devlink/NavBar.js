...
export function NavBar({
  ...
  const [homeHref, setHomeHref] = useState(() => resolveHomepageHref());

  useEffect(() => {
    const href = resolveHomepageHref();
    setHomeHref(href);
  }, []);
      ...
      >
        ...
        {navHamburgerMenu ? (
          ...
          >
            <_Builtin.NavbarButton
              ...
              data-w-id="69b0d3f6-d0cc-2db5-ee2d-841bd346861b"
              tag="div"
            >
        ...
        >
          <_Builtin.NavbarBrand
            ...
            options={{
              href: homeHref || HOMEPAGE_NATIVE_URL,
            }}
          />
          {mainNavMenu ? (
            <_Builtin.NavbarMenu
